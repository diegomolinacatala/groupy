...
export function ModuleChipStatic({ module }: { module: ProjectModule }) {
  return <ChipInner module={module} dragging />;
}
...
export function ModuleChip({ module, onOpen }: ModuleChipProps) {
